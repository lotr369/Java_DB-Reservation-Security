...
public class MvcConfig implements WebMvcConfigurer {
	...
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.any())
				// PathSelectors.any() 를 할경우 모든 경로가 다 사용된다. RestController가 아닌 것 까지사용된다.
	...
	private ApiInfo apiInfo() {
		...
		ApiInfo apiInfo = new ApiInfo("Web Backend", "Project D APIs Samples", "Sample Doc 0.1v", "", contact,
				"Logout", "./logout");
		return apiInfo;
	}
